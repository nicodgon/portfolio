  ...
  return(
    <form className="flex flex-col bg-black/15 w-96 h-[26em] px-16 gap-6 justify-center rounded-3xl max-md:px-8 max-md:w-full">
      <div className="flex flex-col max-md:items-start">
        ...
        <input type="text" placeholder="Nombre" className="rounded max-md:w-full max-md:h-8 bg-slate-700 text-white" />
      </div>
      <div className="flex flex-col max-md:items-start">
        <label className="text-white">Email:</label>
        <input type="text" placeholder="Email" className="rounded max-md:w-full max-md:h-8 bg-slate-700 text-white" />
      </div>
      <div className="flex flex-col max-md:items-start">
