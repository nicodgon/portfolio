    ...
    return (
      <div key={page} className="flex flex-col relative items-center justify-center">
        <a href="/" className="peer">
          <img
            className="h-[calc(1080px/5)] w-[calc(1920px/5)] cursor-pointer hover:blur transition rounded md:max-xl:h-[calc(1080px/3)] md:max-xl:w-[calc(1920px/3)] max-md:w-[16em] max-md:h-[10em]"
            src={page}
            alt="página web"
          />
        </a>
